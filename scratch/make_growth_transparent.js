...
function processDarkBackgroundTransparent(inputPath, outputPath) {
  ...
  // Flood Fill from outer border pixels to remove dark background
  ...
  function isDarkBg(x, y) {
    ...
    // Dark navy background criteria
    return r < 30 && g < 45 && b < 80
  }
  ...
  console.log(`Generated transparent 3D growth chart PNG at: ${outputPath}`)
}

processDarkBackgroundTransparent(
  "d:/Prabha/Projects/2026/Candidleaders/Replicate landing page/src/imports/growth-chart-3d-hd.png",
  "d:/Prabha/Projects/2026/Candidleaders/Replicate landing page/src/imports/growth-chart-3d-transparent.png"
)
