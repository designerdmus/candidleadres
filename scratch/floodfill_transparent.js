...
function processWhiteBgTransparent(inputPath, outputPath) {
  ...
  // Boundary Flood Fill for white background pixels
  ...
  while (head < queue.length) {
    ...
    if (isWhiteBg(x, y)) {
      const idx = pos * 4
      rawData[idx + 3] = 0 // set alpha = 0 (transparent)
  ...
  console.log(`Generated transparent clean Hero 3D laptop PNG at: ${outputPath}`)
}

processWhiteBgTransparent(
  "C:/Users/kprabhakar/.gemini/antigravity-ide/brain/265544c2-159c-4a0d-9f0b-aae5a47e7dc6/media__1786114463972.png",
  "d:/Prabha/Projects/2026/Candidleaders/Replicate landing page/src/imports/hero-laptop-3d-clean.png"
)
